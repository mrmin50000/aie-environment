...
def report(
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Слишком много уникальных значений: **{quality_flags['has_high_cardinality_categoricals']}**\n")
        f.write(f"- Имеются константные столбцы: **{quality_flags['has_constant_columns']}**\n\n")
